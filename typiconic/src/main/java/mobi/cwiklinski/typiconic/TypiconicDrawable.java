 ...
 * <p/>
 * <pre>
 *     new TypiconicDrawable(context, IconValue.icon_star)
 ...
 */
public class TypiconicDrawable extends Drawable {

    public static final int ANDROID_ACTIONBAR_ICON_SIZE_DP = 24;

    private final Context context;

    private final Typiconify.IconValue icon;
    ...
    /**
     * Create an TypiconicDrawable.
     * @param context Your activity or application context.
     * @param icon    The icon you want this drawable to display.
     */
    public TypiconicDrawable(Context context, Typiconify.IconValue icon) {
        this.context = context;
        this.icon = icon;
        paint = new TextPaint();
        paint.setTypeface(Typiconify.getTypeface(context));
     ...
     * @return The current TypiconicDrawable for chaining.
     */
    public TypiconicDrawable actionBarSize() {
     ...
     * @return The current TypiconicDrawable for chaining.
     */
    public TypiconicDrawable sizeRes(int dimenRes) {
     ...
     * @return The current TypiconicDrawable for chaining.
     */
    public TypiconicDrawable sizeDp(int size) {
     ...
     * @return The current TypiconicDrawable for chaining.
     */
    public TypiconicDrawable sizePx(int size) {
        this.size = size;
     ...
     * @return The current TypiconicDrawable for chaining.
     */
    public TypiconicDrawable color(int color) {
     ...
     * @return The current TypiconicDrawable for chaining.
     */
    public TypiconicDrawable colorRes(int colorRes) {
     ...
     * @return The current TypiconicDrawable for chaining.
     */
    public TypiconicDrawable alpha(int alpha) {
        setAlpha(alpha);
        invalidateSelf();
        return this;
    }
